...
<div id="userPreferenceDiv" ng-app="userPreference" data-ng-controller="PopupCtrl">
    <xe-popup-modal show="modalShown" title="{{title}}">
        <popup-content>
            <div>
                <label style="margin-right: 1em" tabindex="0"
                       for="preference" aria-label="'popup.preference.locale.heading' | xei18n"
                        ng-bind="'popup.preference.locale.heading' | xei18n"/>
                </label>
        ...
        <popup-buttons>
            <xe-button ng-click="testing()" id="button_0" xe-type="primary" xe-label="SAVE"  xe-disabled="false"></xe-button>
        </popup-buttons>
    </xe-popup-modal>
</div>