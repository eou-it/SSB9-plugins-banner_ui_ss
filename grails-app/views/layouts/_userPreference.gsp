...
<div id="userPreferenceDiv" dir="auto" ng-app="userPreference" data-ng-controller="PopupCtrl">
    <xe-popup-modal show="modalShown" focusbackelement="tools" pageheader="${g.message(code: 'userpreference.popup.language.heading')}" >
        ...
        <popup-buttons>
            ...
            <xe-button ng-click="errorMessage()" ng-click="errorMessage()" id="errorMessage" xe-type="secondary" xe-label="Error Message Testing" ></xe-button>
            <xe-button ng-click="saveLocale()" id="saveLanguage" xe-disabled="disableButton" xe-type="secondary" xe-label="${g.message(code: 'userpreference.popup.language.save')}" ></xe-button>
        </popup-buttons>
    </xe-popup-modal>
</div>