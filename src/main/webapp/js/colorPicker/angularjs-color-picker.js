        ...
        return {
            ...
            link: function ($scope, element, attrs, control) {
                ...
                $scope.init = function () {
                    ...
                    $scope.find('.color-picker-input').
                        on('blur', $scope.onBlur).
                        on('keydown keypress', $scope.onKey);
                };
                ...
                $scope.onBlur = function(event) {
                    $scope.log('Color Picker: blur Event');
                    $scope.hide();
                };
                ...
                $scope.onKey = function(event) {
                    ...
                    if (event.which === ESC_KEY) {
                        ...
                        $scope.hide();
                        event.preventDefault();
                        //!!TODO: Move to next input/button/control
                    }
                };
