...
$.fn.dataTableExt.oApi.fnColReorder = function ( oSettings, iFrom, iTo )
{
	...
	for ( i=0, iLen=iCols ; i<iLen ; i++ )
	{
		...
		///////////////////////////////////
		// JMM $(oSettings.aoColumns[i].nTh).unbind('click');
		// JMM this.oApi._fnSortAttachListener( oSettings, oSettings.aoColumns[i].nTh, i );
	}
	...
	$.fn.dataTableExt.aoFeatures.push( {
		"fnInit": function( oDTSettings ) {
			...
			if ( typeof oTable._oPluginColReorder == 'undefined' ) {
				...
				// JMM oTable.oApi._fnLog( oDTSettings, 1, "ColReorder attempted to initialise twice. Ignoring second" );
			}
